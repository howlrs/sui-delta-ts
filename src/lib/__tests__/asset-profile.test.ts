...
describe("deriveProfile", () => {
  ...
  it("SUI marginStopPct ≈ -0.50", () => expect(deriveProfile(SUI).marginStopPct).toBeCloseTo(-0.50, 2));
  ...
  it("BTC marginStopPct ≈ -0.30", () => expect(deriveProfile(BTC).marginStopPct).toBeCloseTo(-0.30, 2));
  ...
  it("High-vol marginStopPct ≈ -0.60", () => expect(deriveProfile(HIGH_VOL).marginStopPct).toBeCloseTo(-0.60, 2));
